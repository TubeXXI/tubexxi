...
export const load = async ({ locals, parent, url }) => {
	...
	const title = (await deps.languageHelper.singleTranslate('Admin - Applications', lang)) as SingleResponse;
	...
	const applications = await deps.applicationService.Search(queryParams) as PaginatedResult<ApplicationResponse>;
